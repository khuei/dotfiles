...
local gui0A = '974b46'
local base16_gui0A = '974b46'
local gui0B = 'eceee3'
local base16_gui0B = 'eceee3'
local gui0C = 'aaaaaa'
...
local terminal_color_2 = '#eceee3'
local terminal_color_3 = '#974b46'
...
local terminal_color_10 = '#eceee3'
local terminal_color_11 = '#974b46'
...
local colors_name = 'base16-black-metal-khold'
