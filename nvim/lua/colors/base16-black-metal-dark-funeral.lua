...
local gui0A = '5f81a5'
local base16_gui0A = '5f81a5'
local gui0B = 'd0dfee'
local base16_gui0B = 'd0dfee'
local gui0C = 'aaaaaa'
...
if vim.fn.has('nvim') == 1 then
	...
	local terminal_color_2 = '#d0dfee'
	local terminal_color_3 = '#5f81a5'
	...
	local terminal_color_10 = '#d0dfee'
	local terminal_color_11 = '#5f81a5'
...
local colors_name = 'base16-black-metal-dark-funeral'
