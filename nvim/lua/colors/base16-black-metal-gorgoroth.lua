...
local gui0A = '8c7f70'
local base16_gui0A = '8c7f70'
local gui0B = '9b8d7f'
local base16_gui0B = '9b8d7f'
local gui0C = 'aaaaaa'
...
if vim.fn.has('nvim') == 1 then
	...
	local terminal_color_2 = '#9b8d7f'
	local terminal_color_3 = '#8c7f70'
	...
	local terminal_color_10 = '#9b8d7f'
	local terminal_color_11 = '#8c7f70'
...
local colors_name = 'base16-black-metal-gorgoroth'
