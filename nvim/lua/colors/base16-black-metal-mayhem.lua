...
local gui0A = 'eecc6c'
local base16_gui0A = 'eecc6c'
local gui0B = 'f3ecd4'
local base16_gui0B = 'f3ecd4'
local gui0C = 'aaaaaa'
...
if vim.fn.has('nvim') == 1 then
	...
	local terminal_color_2 = '#f3ecd4'
	local terminal_color_3 = '#eecc6c'
	...
	local terminal_color_10 = '#f3ecd4'
	local terminal_color_11 = '#eecc6c'
...
local colors_name = 'base16-black-metal-mayhem'
