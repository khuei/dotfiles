...
local gui0A = '99bbaa'
local base16_gui0A = '99bbaa'
local gui0B = 'ddeecc'
local base16_gui0B = 'ddeecc'
local gui0C = 'aaaaaa'
...
local terminal_color_2 = '#ddeecc'
local terminal_color_3 = '#99bbaa'
...
local terminal_color_10 = '#ddeecc'
local terminal_color_11 = '#99bbaa'
...
local colors_name = 'base16-black-metal-burzum'
