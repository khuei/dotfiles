...
local gui0A = '626b67'
local base16_gui0A = '626b67'
local gui0B = 'a5aaa7'
local base16_gui0B = 'a5aaa7'
local gui0C = 'aaaaaa'
...
if vim.fn.has('nvim') == 1 then
	...
	local terminal_color_2 = '#a5aaa7'
	local terminal_color_3 = '#626b67'
	...
	local terminal_color_10 = '#a5aaa7'
	local terminal_color_11 = '#626b67'
...
local colors_name = 'base16-black-metal-marduk'
