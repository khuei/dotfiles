...
local gui00 = 'f7f7f7'
local base16_gui00 = 'f7f7f7'
local gui01 = 'e3e3e3'
local base16_gui01 = 'e3e3e3'
local gui02 = 'b9b9b9'
local base16_gui02 = 'b9b9b9'
local gui03 = 'ababab'
local base16_gui03 = 'ababab'
local gui04 = '525252'
local base16_gui04 = '525252'
local gui05 = '464646'
local base16_gui05 = '464646'
local gui06 = '252525'
local base16_gui06 = '252525'
local gui07 = '101010'
local base16_gui07 = '101010'
local gui08 = '7c7c7c'
local base16_gui08 = '7c7c7c'
local gui09 = '999999'
local base16_gui09 = '999999'
local gui0A = 'a0a0a0'
local base16_gui0A = 'a0a0a0'
local gui0B = '8e8e8e'
local base16_gui0B = '8e8e8e'
local gui0C = '868686'
local base16_gui0C = '868686'
local gui0D = '686868'
local base16_gui0D = '686868'
local gui0E = '747474'
local base16_gui0E = '747474'
local gui0F = '5e5e5e'
local base16_gui0F = '5e5e5e'
...
if vim.fn.has('nvim') == 1 then
	local terminal_color_0 = '#f7f7f7'
	local terminal_color_1 = '#7c7c7c'
	local terminal_color_2 = '#8e8e8e'
	local terminal_color_3 = '#a0a0a0'
	local terminal_color_4 = '#686868'
	local terminal_color_5 = '#747474'
	local terminal_color_6 = '#868686'
	local terminal_color_7 = '#464646'
	local terminal_color_8 = '#ababab'
	local terminal_color_9 = '#7c7c7c'
	local terminal_color_10 = '#8e8e8e'
	local terminal_color_11 = '#a0a0a0'
	local terminal_color_12 = '#686868'
	local terminal_color_13 = '#747474'
	local terminal_color_14 = '#868686'
	local terminal_color_15 = '#101010'
...
local colors_name = 'base16-grayscale-light'
